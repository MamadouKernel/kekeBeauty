...
| 4 | Compléter le parcours rendez-vous | OTP fournisseur, créneaux, demande, décision, report et notifications vérifiés | Créneaux calculés selon horaires, fermetures, durée et capacité ; création revalidée en transaction ; expiration et notifications internes réalisées ; report, décision partenaire et SMS réel à terminer |
