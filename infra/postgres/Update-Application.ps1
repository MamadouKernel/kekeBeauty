...
foreach ($name in @('030_acceptation_rdv.sql','040_identite.sql','050_actions_rdv.sql','060_creation_rdv.sql','061_annuaire.sql','070_expiration_rdv.sql','080_report_rdv.sql','090_cloture_notifications.sql','100_proposition_report.sql')) {
